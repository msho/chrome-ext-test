/*** 
 *  TODO: 
 * ** check if can get inner xhr data (if work?)
 * ** disable all calls if url does not have /${window.portalUrl} (securety)
      ...
      XHR.send = function() {
          this.addEventListener('load', function() {
            ...
            console.log(this.url);
              ...
              if (this.url.includes('${window.portalUrl}/addcalendartask.do')) {
